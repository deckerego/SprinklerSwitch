...
class ForecastService {
    async shouldIrrigate() {
        ...
        console.info(`Total surface precipitation (kg/m^2/s) @[${precipitationRate[0].latitude}, ${precipitationRate[0].longitude}]: ${priorAccumulation} + ${forecastAccumulation} = ${totalAccumulation}`);
        ...
        console.info(`Maximum precipitable water (kg/m^2) @[${precipitableWater[0].latitude}, ${precipitableWater[0].longitude}]: ${maxPrecipitable}`);
        ...
        console.info(`Maximum cloud water (kg/m^2) @[${cloudWater[0].latitude}, ${cloudWater[0].longitude}]: ${maxCloudWater}`);
        ...
        console.info(`Least relative humidity 30-0 millibars above ground (%) @[${relativeHumidity[0].latitude}, ${relativeHumidity[0].longitude}]: MIN(${priorRelativeHumidity}, ${forecastRelativeHumidity}) = ${minRelativeHumidity}`);
        ...
        console.info(`Average temperature 30-0 millibars above ground (k) @[${groundTemp[0].latitude}, ${groundTemp[0].longitude}]: AVG(${priorGroundTemp}, ${forecastGroundTemp}) = ${avgGroundTemp}`);
